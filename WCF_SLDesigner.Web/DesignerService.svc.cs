    ...
    public class DesignerService : IDesignerService
    {
        ...
        private static void InvokePreviewDataSet()
        {
            ...
            if (previewDataSet == null)
            {
                ...
                previewDataSet.ReadXmlSchema("e:\\Data\\Demo.xsd");
                previewDataSet.ReadXml("e:\\Data\\Demo.xml");
            }
        }
        #endregion
        ...
        public void SaveReport(byte[] buffer)
        {
            var fileStream = new FileStream("d:\\Report.mrt", FileMode.CreateNew);
